...
import { Sphere } from '../build/three.module.js';
...
lightPosition = new THREE.Vector3(4, 3, 5);
...
var groundPlane = createGroundPlane(20, 20, 50, 50); // width and height
...
function createCylinderObject(){
  let material = new THREE.MeshPhongMaterial({
    flatShading: true,
    color: "lightblue"
  });
  let geometry = new THREE.CylinderGeometry(0.05, 0.5, 2.5, 20);
  let cylinder = new THREE.Mesh(geometry, material);
  cylinder.position.copy(new THREE.Vector3(2, 1, 2));
...
function createSphereObject(){
  ...
  let geometry = new THREE.SphereGeometry(0.5, 32, 64, 32);
  let sphere = new THREE.Mesh(geometry, material);
  sphere.position.copy(new THREE.Vector3(-2, 0.5, -2));
